...
{id:7,description:"",shape:"ellipse",color:"rgba(60,60,60,0.6)",tags:[],font:{color:"#ffffff"},label:"Accessibility"},{id:8,description:"Measures the difficulty of assembling components together",shape:"ellipse",color:"rgba(60,60,60,0.6)",tags:[],font:{color:"#ffffff"},label:"Assembly Difficulty"},
...
{id:51,description:"",shape:"ellipse",color:"rgba(60,60,60,0.6)",tags:[],font:{color:"#ffffff"},label:"Forecasting errors"},{id:52,description:"Increase utilization of equipment, e.g. mashines for enabling economies of scale",shape:"ellipse",color:"rgba(60,60,60,0.6)",tags:[],font:{color:"#ffffff"},label:"Increased equipment intensity"},
